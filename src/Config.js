export const Config = {
    Title: `Dinemate App`,
    BaseUrl: window.location.host.includes("localhost") ? "http://127.0.0.1:8000/api" : `https://mock-api.dinemate.com.au/api`,
    urlbase: window.location.host.includes("localhost") ? "http://127.0.0.1:8000/media/" : "https://mock-api.dinemate.com.au/media/", 
