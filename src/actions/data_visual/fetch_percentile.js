...
function _success(success) {
  return {type: 'FETCH_PERCENTILE_SUCCESS', success}
}

function _error(error) {
  return {type: 'FETCH_PERCENTILE_ERROR', error}
}

function _processing(processing) {
    return { type: 'FETCH_PERCENTILE_PROCESSING', processing }
}

export function fetchPercentile() {
  // let params = {
  ...
  return dispatch => {
    ...
    let config = {
      url: Config.BaseUrl + `/percent-increase`,
      method: "get",
      dataType: 'json',
      // params,
      headers: {
...
export default fetchPercentile;
