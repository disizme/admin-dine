...
function _success(success) {
  return {type: 'FETCH_MONTH_COUNT_SUCCESS', success}
}

function _error(error) {
  return {type: 'FETCH_MONTH_COUNT_ERROR', error}
}

function _processing(processing) {
    return { type: 'FETCH_MONTH_COUNT_PROCESSING', processing }
}

export function fetchMonthCount() {
  // let params = {
  ...
  return dispatch => {
    ...
    let config = {
      url: Config.BaseUrl + `/monthlycount`,
      method: "get",
      dataType: 'json',
      // params,
      headers: {
...
export default fetchMonthCount;
