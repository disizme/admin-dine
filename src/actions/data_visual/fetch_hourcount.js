...
function _success(success) {
  return {type: 'FETCH_HOUR_COUNT_SUCCESS', success}
}

function _error(error) {
  return {type: 'FETCH_HOUR_COUNT_ERROR', error}
}

function _processing(processing) {
    return { type: 'FETCH_HOUR_COUNT_PROCESSING', processing }
}
