...
function _success(success) {
  return {type: 'FETCH_MY_PLAN_SUCCESS', success}
}

function _error(error) {
  return {type: 'FETCH_MY_PLAN_ERROR', error}
}

function _processing(processing) {
    return { type: 'FETCH_MY_PLAN_PROCESSING', processing }
}
...
export function fetchMyPlan() {
  ...
  return dispatch => {
    ...
    let config = {
      url: Config.BaseUrl + `/payment/myplan`,
      method: "get",
      dataType: 'json',
      // params,
      headers: {
