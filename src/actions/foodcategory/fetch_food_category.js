...
function _error(error) {
  return {type: 'FETCH_FOOD_CATEGORY_ERROR', error}
}

function _processing(processing) {
    return { type: 'FETCH_FOOD_CATEGORY_PROCESSING', processing }
}
...
export function fetchFoodCategory() {
  ...
  //     // q: attribute.q || ``,
  //     sort_field: (attribute && attribute.sort_field) || `id`,
...
export default fetchFoodCategory;
